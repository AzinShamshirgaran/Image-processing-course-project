...
x = cos(2*pi*frequency * samples);

% Play the sine wave.
sound(x, sample_rate);
% Save it.
audiowrite('one_sine.wav', x, sample_rate);

% Plot the first 100 samples of the sine wave.
figure
...
% Save as png file.
imwrite(s_spectrum_log_scale,'one_sine_spect.png');
